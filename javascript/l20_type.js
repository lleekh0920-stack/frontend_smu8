...
//생성자함수의 이름이 파스칼 규칙인 것은 개발자간의 약속
function Person(){
    this.name="경민코딩";
    this.age=40;
} // type(생성자함수) : 객체의 형(타입)으로 쉽게 객체를 생성, return은 동작하지 않음

let km=new Person();
// 생성자 함수는 객체를 생성하는 new 연산자로 호출되고 만들어진 객체를 내놓는다.
console.log(km)
//함수가 타입이 되는 언어를 함수형언어라 부른다.
console.log(new Person());
console.log(new Person());
console.log(new Person());
console.log(new Person());
console.log(new Person());
console.log(new Person()); // 객체 -> 인스턴스 (쉽게 만들기 때문)
